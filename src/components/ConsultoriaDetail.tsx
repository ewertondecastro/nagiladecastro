...
export default function ConsultoriaDetail({ dict, locale, card }: Props) {
  ...
  return (
    <main className="w-full bg-background min-h-screen">
      ...
      {/* Depoimentos com o print real como prova */}
          ...
          <FadeIn className="max-w-5xl mx-auto flex flex-col gap-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-start">
              {d.testimonials.map((t, i) => (
                <figure key={i} className="flex flex-col bg-background-soft border border-cream-line overflow-hidden">
                  ...
                  {t.image && (
                    ...
                    >
                      ...
                      />
                      <span
                        className="pointer-events-none absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-background-soft to-transparent"
                        aria-hidden="true"
                      />
