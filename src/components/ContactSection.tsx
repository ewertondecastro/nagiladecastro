    ...
    <section id="contato" className="w-full py-28 md:py-40 px-8 md:px-16 lg:px-20 bg-background scroll-mt-16">
      ...
      <FadeIn className="max-w-3xl mx-auto mt-14 flex flex-col items-center gap-5 text-center">
        ...
        <a
          ...
          className="group inline-flex items-center gap-3 font-barlow-condensed text-sm tracking-widest uppercase px-8 py-4 border border-rose-accent text-rose-accent hover:bg-rose-accent hover:text-background transition-colors duration-200"
        >
          {contact.cta}
        </a>
